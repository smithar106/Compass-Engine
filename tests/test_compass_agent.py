...
class TestConfig(unittest.TestCase):
    ...
    def test_defaults_when_vars_absent(self):
        ...
        self.assertEqual(problems, [])
        self.assertEqual(settings.llm_provider, "deepseek")
        self.assertEqual(settings.max_daily_llm_usd, 25.00)
        self.assertEqual(settings.max_total_llm_usd, 50.00)
        self.assertEqual(settings.llm_concurrency, 8)
        self.assertEqual(settings.max_docs_per_cycle, 50)
        self.assertEqual(settings.sleep_seconds, 120)
        self.assertFalse(settings.auto_publish)
