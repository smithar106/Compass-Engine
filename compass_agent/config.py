...
class Settings:
    ...
    max_daily_llm_usd: float = 25.00
    max_total_llm_usd: float = 50.00
    llm_concurrency: int = 8
    max_docs_per_cycle: int = 50
    ...
    def from_env(cls, env: dict | None = None) -> "tuple[Settings, list[str]]":
        ...
        settings = cls(
            ...
            max_daily_llm_usd=_num("AGENT_MAX_DAILY_LLM_USD", 25.00),
            max_total_llm_usd=_num("AGENT_MAX_TOTAL_LLM_USD", 50.00),
            llm_concurrency=_int("AGENT_LLM_CONCURRENCY", 8),
            max_docs_per_cycle=_int("AGENT_MAX_DOCS_PER_CYCLE", 50),
            sleep_seconds=_num("AGENT_SLEEP_SECONDS", 120),
